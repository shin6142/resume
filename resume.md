...
既存機能の運用保守や新規マイクロサービス開発を担当しました。
運用保守では、不具合改修や機能追加、ユーザーからの問い合わせの対応を担当しました。
新規開発では、アプリケーション開発に加え、CICDの整備やIaCツールによるインフラリソース構築を担当しました。
...
施設と保護者間の用品販売・購入を管理する新規サービスの開発を担当。仕様策定から開発・テスト・リリースまで一貫して担当。
